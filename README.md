...
A janela é 1200 por 700 (menor quando a área de trabalho não comporta; issue #20). O visual é a direção E ("Pergaminho") escolhida em 2026-09-07: bege `#ebe7dc` em toda a janela, sem véu nem cartão sobre a arte, e a deusa Gabija (`tos-1` do site, `assets/goddess.webp`, 560 px com o fundo removido) de pé na borda direita, cortada embaixo por uma máscara suave e com uma poça de luz quente atrás (`Backdrop`). Nas telas Notícias e Configurações ela dá um passo para a direita (só `transform`), para a coluna mais larga ter espaço. O `App.tsx` do renderer monta:
